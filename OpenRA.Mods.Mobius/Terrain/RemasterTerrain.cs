...
namespace OpenRA.Mods.Mobius.Terrain
{
	...
	public class RemasterTerrain : ITemplatedTerrainInfo, ITerrainInfoNotifyMapCreated
	{
		...
		{
			UseRemasteredTerrain = ((RemasterFileSystemLoader)modData.FileSystemLoader).UseRemasteredContent;
			...
			Templates = yaml["Templates"].ToDictionary().Values
				.Select(y => (TerrainTemplateInfo)new RemasterTerrainTemplateInfo(this, y))
